...
Some example data science plots in R using ggplot2.  See [https://github.com/WinVector/WVPlots](https://github.com/WinVector/WVPlots) for details.
...
WVPlots::GainCurvePlotWithNotation(frm, "model", "value", title="Example Gain Curve with annotation", 
...
```{r}
WVPlots::ConditionalDistributionPlot(frm, "model", "isValuable", title="Example conditional distribution plot")
```
